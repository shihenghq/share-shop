 ...
 */
package com.tudo.share.common.spring;
...
public class SpeedUpSpringProcessor implements BeanFactoryPostProcessor {
    ...
    private boolean needRemove(String beanName, BeanDefinition beanDefinition) {
        ...
        //spring data jpa
        if(className.equals("com.tudo.share.common.repository.support.SimpleBaseRepositoryFactoryBean") ||
    ...
    public static void main(String[] args) {
        String c = "com.tudo.share.sys.user.web.bind.A";
